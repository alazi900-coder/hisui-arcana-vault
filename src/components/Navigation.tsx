...
import { Home, Grid3X3, Swords, Package, MapPin, ClipboardList, Settings } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/locations', icon: MapPin, labelAr: 'مواقع', labelEn: 'Locations' },
...
export function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-50 glass border-t border-border/50 safe-area-inset">
